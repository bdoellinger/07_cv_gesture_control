...
def main():
    ...
    while camera_recognised:
        # try to get image from webcam
        camera_recognised, img = cap.read()

        if not camera_recognised:
            print("camera feed lost, image processing will be aborted")
            break
        ...
        # determine audio volume according to distance between thumb and index finger, and visualize
